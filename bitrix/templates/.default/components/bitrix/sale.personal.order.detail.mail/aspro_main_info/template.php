...
<?if($arParams["SHOW_ORDER_BASE"]=='Y' && (strlen($arResult["ERROR_MESSAGE"]) || $arResult["ACCOUNT_NUMBER"])):?>
	<div class="border_wrapper" style="color:#888888;font-size:0px;border:1px solid #e7e7e7;padding: 19px 28px 0px;margin-top:10px;margin-bottom:10px;">
		...
		<?else:?>	
			...
			<div style="display:inline-block;vertical-align:top;font-size:14px;width:100%;max-width: 140px;padding-bottom: 17px;">
