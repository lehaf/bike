    ...
    <? else: ?>
        <div id="ajax_auth" class="auth-page pk-page">
            <div class="auth_wrapp">
                <div class="wrap_md1">
                    <div class="form">
                        <form id="auth-page-form" name="system_auth_form<?= $arResult['RND'] ?>" method="post"
                                ...
                                <div class="tabs tabs--compact">
                                    <div class="form-control">
                                        <ul class="nav nav-tabs" style="display:none">
                                            <li class="<?= ($bActivePhoneTab ? 'active' : '') ?>"><a
                                                        href="#auth_by_phone" data-toggle="tab"
                                                        data-type="phone"><?= GetMessage('AUTH_BU_PHONE_TITLE') ?></a>
                                            </li>
                                            <li class="<?= ($bActivePhoneTab ? '' : 'active') ?>"><a
                                                        href="#auth_by_login" data-toggle="tab"
                                                        data-type="login"><?= GetMessage('AUTH_BU_LOGIN_EMAIL_TITLE') ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        <div class="tab-pane <?= ($bActivePhoneTab ? 'active' : '') ?>"
                                             id="auth_by_phone">
                                            <? endif; ?>
                                            <? if ($bUsePhoneInput): ?>
                                            <? if ($arResult['SHOW_SMS_FIELD']): ?>
                                                ...
                                                <div class="form-control">
                                                    <label for="SMS_CODE_POPUP"><span><?= GetMessage('auth_sms_code') ?>&nbsp;<span
                                                                    class="required-star">*</span></span></label>
                                                    <input type="text" name="SMS_CODE" id="SMS_CODE_POPUP"
                                            ...
                                            <div class="form-control phone_or_login">
                                                <label for="AUTH_PHONE_OR_LOGIN"
                                                       class=""><span><?= GetMessage('auth_phone_number') ?>&nbsp;<span
                                                                class="star">*</span></span></label>
                                                <input id="AUTH_PHONE_OR_LOGIN" class="required phone" type="tel"
                                                       name="USER_PHONE_NUMBER" maxlength="50" autocomplete="off"
                                                       value="" tabindex="1"/>
                                            ...
                                            <div class="form-control">
                                                <label for="USER_PASSWORD_POPUP"><span><?= GetMessage('auth_password2') ?>&nbsp;<span
                                                                class="required-star">*</span></span></label>
                                                <input type="password" name="USER_PASSWORD" id="USER_PASSWORD_POPUP"
                                                       class="required password" maxlength="50" value=""
                                        ...
                                        <div class="tab-pane <?= ($bActivePhoneTab ? '' : 'active') ?>"
                                            ...
                                            <? if (!$bUsePhoneInput || ($bUsePhoneInput && !$arResult['SHOW_SMS_FIELD'])): ?>
                                                <div class="form-control">
                                                    <label for="USER_LOGIN_POPUP"><span><?= GetMessage('auth_login') ?>&nbsp;<span
                                                                    class="required-star">*</span></span></label>
                                                    <input type="text" name="USER_LOGIN" id="USER_LOGIN_POPUP"
                                                           class="required" maxlength="50"
                                                           value="<?= $arResult['USER_LOGIN'] ?>" autocomplete="on"
                                                           tabindex="1"/>
                                                </div>
                                                <div class="form-control">
                                                    <label for="USER_PASSWORD_POPUP"><span><?= GetMessage('auth_password') ?>&nbsp;<span
                                                                    class="required-star">*</span></span></label>
                                                    <input type="password" name="USER_PASSWORD" id="USER_PASSWORD_POPUP"
                                                           class="required password" maxlength="50" value=""
                                                           autocomplete="off" tabindex="2"/>
                            ...
                            <? endif; ?>
                                ...
                                <? if ($arResult['CAPTCHA_CODE']): ?>
                                    ...
                                    <div class="form-control captcha-row clearfix">
                                        <label for="FORGOTPASSWD_CAPTCHA"><span><?= GetMessage('CAPTCHA_PROMT') ?>&nbsp;<span
                                                        class="star">*</span></span></label>
                                        ...
                                        <div class="captcha_input">
                                            <input id="FORGOTPASSWD_CAPTCHA" type="text" class="inputtext captcha"
                                                   name="captcha_word" size="30" maxlength="50" value="" required/>
                                        </div>
                                    </div>
                                    <div class="clearboth"></div>
                                <? endif; ?>
                            ...
                            <div class="form_footer">
                                <div class="filter block">
                                    <div class="prompt remember onoff">
                                        <input type="checkbox" id="USER_REMEMBER_frm" name="USER_REMEMBER" value="Y"
                                               tabindex="5" <?= (isset($_REQUEST['USER_REMEMBER']) && $_REQUEST['USER_REMEMBER'] === 'Y' ? 'checked' : '') ?> />
                                        <label for="USER_REMEMBER_frm" title="<?= GetMessage('AUTH_REMEMBER_ME') ?>"
                                               tabindex="5"><?= GetMessage('AUTH_REMEMBER_SHORT') ?></label>
                                    </div>
                                    <? if (!$arResult['SHOW_SMS_FIELD']): ?>
                                        <a class="forgot" href="<?= $arResult['AUTH_FORGOT_PASSWORD_URL'] ?>"
                                           tabindex="4"><?= GetMessage('AUTH_FORGOT_PASSWORD_2') ?></a>
                                    <? endif; ?>
                                </div>
                                    ...
                                    <div class="line-block line-block--column line-block--align-flex-start line-block--24-vertical">
                                        ...
                                        <div class="line-block__item width100">
                                            <? if ($arResult['PHONE_AUTH_PARAMS']['USE']): ?>
                                                <? if ($arResult['SHOW_SMS_FIELD']): ?>
                                                    <button class="btn btn-default btn-lg" type="submit" name="Login1"
                                                            value="Y" tabindex="2">
                                                        <span><?= GetMessage('AUTH_LOGIN_BUTTON') ?></span></button>
                                                <? else: ?>
                                                    <button class="btn btn-default btn-lg<?= ($bActivePhoneTab ? '' : ' hidden') ?>"
                                                            data-type="phone" type="submit" name="Login1" value="Y"
                                                            tabindex="2">
                                                        <span><?= GetMessage('auth_get_sms_code') ?></span></button>
                                                    <button class="btn btn-default btn-lg<?= ($bActivePhoneTab ? ' hidden' : '') ?>"
                                                            data-type="login" type="submit" name="Login1" value="Y"
                                                            tabindex="2">
                                                        <span><?= GetMessage('AUTH_LOGIN_BUTTON') ?></span></button>
                                                    <!--noindex--><a href="<?= $arResult['AUTH_REGISTER_URL']; ?>"
                                                                     rel="nofollow"
                                                                     class="btn btn-transparent-border-color btn-lg pull-right register"
                                            ...
                                            <? else: ?>
                                                <button class="btn btn-default btn-lg" type="submit" name="Login1"
                                                        value="Y" tabindex="3">
                                                    <span><?= GetMessage('AUTH_LOGIN_BUTTON') ?></span></button>
                                                <div class="pull-right" style="width: max-content;display: flex;flex-direction: column; gap: 10px">
                                                    <!--noindex--><a href="<?= $arResult['AUTH_REGISTER_URL']; ?>"
                                                                     rel="nofollow"
                                                                     class="btn btn-transparent-border-color btn-lg pull-right register"
                                                                     tabindex="6"><?= GetMessage('AUTH_REGISTER_FIS') ?></a>
                                                    <!--/noindex-->
                                                    <!--noindex--><a href="/info/faq/?tab=accordion34_10" rel="nofollow"
                                                                     class="btn btn-transparent-border-color btn-lg pull-right register"
                                                                     tabindex="6"><?= GetMessage('AUTH_REGISTER_LEGAL') ?></a>
                                                    <!--/noindex-->
                                                </div>
                                ...
                                <? if ($arResult['PHONE_AUTH_PARAMS']['USE'] && !$arResult['SHOW_SMS_FIELD']): ?>
                                    <div class="licence_block hidden">
                                        <label><? $APPLICATION->IncludeFile(SITE_DIR . "include/auth_phone_licenses_text.php", array(), array("MODE" => "html", "NAME" => "LICENSES")); ?></label>
                                    </div>
                                <? endif; ?>
                                <? if ($arResult['SHOW_SMS_FIELD']): ?>
                                    <? $rand = rand(1, 99); ?>
                                    <div id="bx_auth_error<?= $rand ?>"
                                         style="display:none;"><? ShowError("error") ?></div>
