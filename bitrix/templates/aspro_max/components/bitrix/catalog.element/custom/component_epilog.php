        ...
        <? if ($templateData['OFFERS_INFO']['OFFERS']): ?>
            <? if ($templateData['OFFERS_INFO']['OFFER_GROUP']): ?>
                <? foreach ($templateData['OFFERS_INFO']['OFFERS'] as $offerId => $arOfferGroup): ?>
                    ...
                    <span data-offerSetId="<?= $offerId ?>" id="<?= $templateData['ID_OFFER_GROUP'] . $offerId ?>"
                          <? if ($offerId != $templateData["OFFERS_INFO"]["CURRENT_OFFER"]): ?>style="display: none;"<? endif; ?>>
            ...
            <div class="ordered-block js-store-scroll tabs-block" data-hash="Y">
                            ...
                            <? foreach ($arTabOrder as $value): ?>
                                ...
                                <? if ($value == "desc"): ?>
                                    <? if ($bShowDetailTextTab || ($arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB" && $bShowPropsTab)): ?>
                                        <li class="bordered rounded3 <?= ((!($iTab++) && (!$templateData['HIDE_ADDITIONAL_GALLERY'] || $bShowDetailText || $bShowDocs)) ? 'active' : '') ?> <?= $templateData['HIDE_ADDITIONAL_GALLERY'] && !$bShowDocs && !$bShowDetailText ? "hidden" : ""; ?>">
                                            <a href="#desc"
                                ...
                                <? if ($value == "char"): ?>
                                    <? if ($bShowPropsTab && $arParams["PROPERTIES_DISPLAY_LOCATION"] == "TAB"): ?>
                                        <li class="bordered rounded3 <?= (!($iTab++) || ($templateData['HIDE_ADDITIONAL_GALLERY'] && !$bShowDetailText && !$bShowDocs) ? 'active' : '') ?>">
                                            <a href="#props"
                                ...
                                <? if ($value == "buy"): ?>
                                    <? if ($bShowHowBuyTab): ?>
                                        <li class="bordered rounded3 <?= (!($iTab++) ? 'active' : '') ?>"><a href="#buy"
                ...
                <div class="tab-content<?= ($i <= 1 ? ' not_tabs' : '') ?>">
                    ...
                    <? foreach ($arTabOrder as $value): ?>
                        ...
                        <? if ($value == "desc"): ?>
                            <? if ($bShowDetailTextTab || ($arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB" && $bShowPropsTab)): ?>
                                <div class="tab-pane <?= (!($iTab++) && (!$templateData['HIDE_ADDITIONAL_GALLERY'] || $bShowDocs || $bShowDetailText) ? 'active' : '') ?>"
                                     id="desc">
                                    <? if ($bShowDetailText): ?>
                                        <? if ($i == 1): ?>
                        ...
                        <? if ($value == "char"): ?>
                            <? if ($bShowPropsTab && $arParams["PROPERTIES_DISPLAY_LOCATION"] == "TAB"): ?>
                                <div class="tab-pane <?= $value; ?> <?= (!($iTab++) || ($templateData['HIDE_ADDITIONAL_GALLERY'] && !$bShowDetailText && !$bShowDocs) ? 'active' : '') ?>"
                                     id="props">
                                    <? if ($i == 1): ?>
                                        <div class="ordered-block__title option-font-bold font_lg">
                                            <?= ($arParams["T_CHARACTERISTICS"] ? $arParams["T_CHARACTERISTICS"] : Loc::getMessage("T_CHARACTERISTICS")); ?>
                            ...
                            <? if ($bShowBuyServicesTab): ?>
                                <div class="tab-pane <?= $value; ?> <?= (!($iTab++) ? 'active' : '') ?>"
                                    ...
                                    <div class='buy_services_wrap js-scroll-services'
                                         data-parent_product=<?= $currentProductId ?>>
                                        <?= $htmlBuyServices; ?>
                                    </div>
                                </div>
                            <? endif; ?>
    ...
    <? //tabs mode?>
        <div class="ordered-block <?= $code ?>">
                ...
                <ul class="nav nav-tabs">
                    <? if ($bShowAssociatedTab): ?>
                        <li class="active"><a href="#assoc" data-toggle="tab"
                                              class="linked"><?= $arParams["DETAIL_ASSOCIATED_TITLE"]; ?></a></li>
                    <? endif; ?>
                    <? if ($bShowExpandablesTab): ?>
                        <li class="<?= $bShowAssociatedTab ? '' : 'active' ?>"><a href="#expandables" data-toggle="tab"
            ...
            <? if ($bNavTabs): ?>
                <div class="tab-pane active cur" id="assoc">
                    ...
                    <div class="cur">
                        ...
                        <div class="assoc-block js-load-block loader_circle tabs_slider nav-data_block"
                             data-block="assoc" data-file="<?= $APPLICATION->GetCurURI() ?>">
                            <div class="stub"></div>
                    ...
                    <div class="tab-pane <?= (!$templateData['ASSOCIATED'] ? "active cur" : ""); ?>" id="expandables">
                        ...
                        <div class="cur">
                            ...
                            <div class="expandables-block js-load-block loader_circle tabs_slider nav-data_block"
                                 data-block="expandables" data-file="<?= $APPLICATION->GetCurURI() ?>">
                                <div class="stub"></div>
                ...
                <? endif; ?>
                <div class="ordered-block cur" data-code="bigdata">
                    <div class="ordered-block__title option-font-bold font_lg">
                    ...
                    <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "SORT_BY2" => "RAND",
                            "SORT_ORDER2" => "DESC",
                            "FILTER_NAME" => "arrProductsFilterCustom",
                            "INCLUDE_SUBSECTIONS" => "Y",
                            "SHOW_ALL_WO_SECTION" => "Y",
                            "PAGER_TEMPLATE" => "ajax",
                            "DISPLAY_TYPE" => "block",
                            ...
                            "SECTION_ID" => ($elementCount > 0) ? $arResult["IBLOCK_SECTION_ID"] : $secondLevelParent['ID'],
                            "SECTION_CODE" => "",
                            "SHOW_BIG_BLOCK" => "N",
                            "DISPLAY_TOP_PAGER" => "N",
