...
if($arResult){
    ...
    foreach ($sections as $sect) {
        $menuTypes[$sect['NAME']] = $sect;
    }

    foreach($arResult as $itemKey => $menuLink) {
        if (!empty($menuTypes[$menuLink['TEXT']])) $arResult[$itemKey]['MENU_TYPE'] = $menuTypes[$menuLink['TEXT']]['UF_TYPE_MENU'];
    }
