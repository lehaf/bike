...
<div class="form <?= $arResult["arForm"]["SID"] ?>  _form-new">
    <!--noindex-->
    <div class="form_head">
    ...
    <? } else { ?>
        ...
        <div class="form_body">
            <? if (is_array($arResult["QUESTIONS"])): ?>
                <? foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion): ?>
                    <?php if ($FIELD_SID === 'ELEMENT_ID'): ?>
                        <input type="hidden" data-sid="ELEMENT_ID" name="form_hidden_<?=$arQuestion['STRUCTURE'][0]['ID']?>" value="<?=$arParams['ELEMENT_ID']?>">
                     <?php else:?>
        ...
        <div class="form_footer">
            <div class="_form-text">
                Модератор проверит это объявление и примет решение, как с ним поступить
            </div>
            <div class="line-block form_footer__bottom _form-btn-block">
                <div class="line-block__item _form-btn">
