        ...
        <div class="save-inner">
                    ...
                    <?php if (!empty($arResult['SEARCHES'])): ?>
                        <?php foreach ($arResult['SEARCHES'] as $search): ?>
                            <div class="save-list__item" data-id="<?= $search['ID'] ?>">
                                <a href="<?= $search['FILTER_SECTION_URL'] . $search['UF_FILTER_QUERY'] ?>"
                                   class="search-popup__mark"><?= $search['UF_TITLE'] ?></a>
                                <a href="<?= $search['FILTER_SECTION_URL'] . $search['UF_FILTER_QUERY'] ?>"
                                   class="search-popup__parameters"><?= $search['UF_DESCRIPTION'] ?></a>
                                <div class="form-row form-row-checkbox form-row-checkbox--selection no-save">
                                    ...
                                    >
                                    <label for="emailMes-<?= $search['ID'] ?>" class="checkbox-label">Уведомления на
                                        электронную почту</label>
                                </div>
                                ...
                                <div class="form-group custom-select-inner form-group-custom-select color-select no-save no-send <?= ((int)$search['UF_NOTIFY_INTERVAL'] !== 0) ? 'is-active' : '' ?>">
                                    <select class="select-type right-select notify-select no-send"
                                            id="notify-select-<?= $search['ID'] ?>">
                                        <option value="">
                                            Получать письма
                                        </option>
                                        <option value="reset">
                                ...
                                <div class="remove-save-item">
                                    <svg width="14" height="16" viewBox="0 0 14 16" fill="none"
                                        ...
                                        <path d="M9.14286 3.42857H4.57143C4.25589 3.42857 4 3.17269 4 2.85714V0.571429C4 0.255886 4.25589 0 4.57143 0H9.14286C9.4584 0 9.71429 0.255886 9.71429 0.571429V2.85714C9.71429 3.17269 9.4584 3.42857 9.14286 3.42857ZM5.14286 2.28571H8.57143V1.14286H5.14286V2.28571Z"
                                              fill="#ED1C24"/>
                                        <path d="M5.14272 13.7138C4.82717 13.7138 4.57129 13.4579 4.57129 13.1424V7.42812C4.57129 7.11258 4.82717 6.85669 5.14272 6.85669C5.45826 6.85669 5.71415 7.11258 5.71415 7.42812V13.1424C5.71415 13.4579 5.45826 13.7138 5.14272 13.7138Z"
                                              fill="#ED1C24"/>
                                        <path d="M8.57094 13.7143C8.2554 13.7143 7.99951 13.4584 7.99951 13.1429V7.42861C7.99951 7.11306 8.2554 6.85718 8.57094 6.85718C8.88648 6.85718 9.14237 7.11306 9.14237 7.42861V13.1429C9.14237 13.4584 8.88648 13.7143 8.57094 13.7143Z"
                                              fill="#ED1C24"/>
                                    </svg>
                                    Удалить поиск
                                </div>
            ...
            <div class="save-search <?= ($arResult['EXIST_SEARCH']) ? 'active' : '' ?>">
                <span class="save-search__prev"
                      data-auth="<?= (\Bitrix\Main\Engine\CurrentUser::get()->getId()) ? 'Y' : 'N' ?>">
...
<path d="M8.98109 1.35706L1.69526 8.64289M9.03313 8.69493L1.64322 1.30502" stroke="#ED1C24" stroke-width="1.4"
      stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <?php if (!empty($arResult['ITEMS']['motor_type_' . $sectCode]['VALUES'])): ?>
                <div class="form-row__col form-row__col-30 gap-20 <?= ($arResult['ITEMS']['motor_type_' . $sectCode]['HAS_CHECKED']) ? 'store-active' : '' ?>">
      ...
      stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="form-row flex-row">
            ...
            <?php if (!empty($arResult['ITEMS']['cylinders_count_' . $sectCode]['VALUES'])): ?>
                <div class="form-row__col form-row__col-30 <?= ($arResult['ITEMS']['cylinders_count_' . $sectCode]['HAS_CHECKED']) ? 'store-active' : '' ?>">
                    <div class="form-group custom-select-inner form-group-custom-select color-select">
