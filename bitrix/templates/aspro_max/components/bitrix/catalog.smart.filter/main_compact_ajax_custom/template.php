...
$this->addExternalJs(SITE_TEMPLATE_PATH . "/js/custom/mainLocationFilter.js", ['GROUP' => 1000]);
?>
<?php
if ($arResult["ITEMS"]) {
    ?>
            ...
            <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                ...
                <div class="bx_filter_parameters">
                    ...
                    foreach ($arResult["ITEMS"] as $key => $arItem) {
                        ...
                        <div class="bx_filter_parameters_box bx_sort_filter <?= $class; ?>"
                            ...
                            <div class="bx_filter_parameters_box_title">
                                <div><?= $arItem["NAME"] ?></div><?= CMax::showIconSvg("down colored_theme_hover_bg-el", SITE_TEMPLATE_PATH . '/images/svg/trianglearrow_down.svg', '', '', true, false); ?>
                            </div>
                    ...
                    foreach ($arResult["ITEMS"] as $key => $arItem) {
                        ...
                        $isFilter = true;
                        ?>
                        <div class="bx_filter_parameters_box prop_type_<?= $arItem["PROPERTY_TYPE"]; ?><?= (isset($arItem['PROPERTY_SET']) && $arItem['PROPERTY_SET'] == 'Y' ? ' set' : ''); ?>"
                             data-prop_code="<?= strtolower($arItem["CODE"]); ?>"
                             data-property_id="<?= $arItem["ID"] ?>">
                            <span data-f="<?= Loc::getMessage('CT_BCSF_SET_FILTER') ?>"
                                  data-fi="<?= Loc::getMessage('CT_BCSF_SET_FILTER_TI') ?>"
                            ...
                            <? if (!$arItem['IS_PROP_INLINE']) {
                                ...
                                <div class="bx_filter_parameters_box_title title rounded3 box-shadow-sm">
                                    ...
                                    <span class="delete_filter colored_theme_bg_hovered_hover"
                                          title="<?= Loc::getMessage("CLEAR_VALUE") ?>">
										<?= CMax::showIconSvg("delete_filter", SITE_TEMPLATE_PATH . '/images/svg/catalog/cancelfilter.svg', '', '', false, false); ?>
									</span>
                                    <?= CMax::showIconSvg("down colored_theme_hover_bg-el", SITE_TEMPLATE_PATH . '/images/svg/trianglearrow_down.svg', '', '', true, false); ?>
                                </div>
                                    ...
                                    switch ($arItem["DISPLAY_TYPE"]) {
                                        ...
                                        <?endforeach ?>
                                            ...
                                            <div class="inner_expand_text"><span
                                                        class="expand_block colored_theme_text_with_hover"><?= Loc::getMessage("FILTER_EXPAND_VALUES"); ?></span>
                                            </div>
                                        <?endif; ?>
                                            <?
                                            break;
                                    ...
                                    <div class="props_list">
                                        <? if ($arParams["SHOW_HINTS"] !== 'N') {
                                            ...
                                            <? if ($arItem["FILTER_HINT"] && strpos($arItem["FILTER_HINT"], 'line') === false) {
                                                ?>
                                                <div class="hint"><span class="icon"><i>?</i></span><span
                                                            class="text"><?= Loc::getMessage('HINT'); ?></span>
                                                    <div class="tooltip"
                ...
                <? if ($isFilter):?>
                    <div class="clb"></div>
                    <button class="bx_filter_search_reset btn-link-text font_sxs colored_theme_text_with_hover<?= ($bActiveFilter && $bActiveFilter[1] != 'clear' ? '' : ' hidden'); ?>"
                    ...
                    <div class="bx_filter_button_box active hidden colored_theme_bg">
                        <div class="bx_filter_block">
                            <div class="bx_filter_parameters_box_container">
                                ...
                                <button class="bx_filter_search_reset btn btn-default btn-transparent round-ignore<?= ($bActiveFilter && $bActiveFilter[1] != 'clear' ? '' : ' hidden'); ?> pull-left"
                                        type="reset" id="del_filter1" name="del_filter1" data-href=""
                                        title="<?= Loc::getMessage("CT_BCSF_DEL_FILTER") ?>">
                                ...
                                <div class="filter-bnt-wrapper">
                                    <button class="bx_filter_search_button btn btn-default btn-lg btn-transparent round-ignore"
                                            ...
                                            data-href=""><?= Loc::getMessage("CT_BCSF_SET_FILTER") ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
