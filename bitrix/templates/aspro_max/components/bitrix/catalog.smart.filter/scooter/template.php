...
//pr($arResult['ITEMS']['cylinder_place_' . $sectCode]);
//pr($arResult['ITEMS']);
?>
...
<path d="M8.98109 1.35706L1.69526 8.64289M9.03313 8.69493L1.64322 1.30502" stroke="#ED1C24" stroke-width="1.4"
      stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="form-row__col-10">
                ...
                <!--                        <div class="form-group custom-select-inner form-group-custom-select color-select">-->
                <!--                            <select name="-->
                <?php //= current($arResult['ITEMS']['cylinders_count_' . $sectCode]['VALUES'])['CONTROL_NAME_ALT'] ?><!--"-->
                <!--                                    class="select-type custom-select">-->
                <!--                                <option value="" selected>-->
                <!--                                    Цилиндров-->
                <!--                                </option>-->
...
<path d="M8.98109 1.35706L1.69526 8.64289M9.03313 8.69493L1.64322 1.30502" stroke="#ED1C24" stroke-width="1.4"
      stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="form-row flex-row">
            <!--            мощность-->
            <?php if (!empty($arResult['ITEMS']['energy']['VALUES'])): ?>
                <div class="form-row__col-30">
        ...
        <div class="form-row flex-row">
            ...
            <div class="form-row__col-30">
                <div class="form-row form-row-checkbox selection-block-checkbox-row">
                    ...
                    <!--                    <div class="col">-->
                    <!--                        <input type="checkbox" class="input-checkbox" name="Торг" id="bargain">-->
                    <!--                        <label for="bargain" class="checkbox-label">Торг</label>-->
                    <!--                    </div>-->
                    <div class="col">
