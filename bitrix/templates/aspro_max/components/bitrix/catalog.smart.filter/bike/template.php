...
?>
<div class="empty loading-state" style="position: relative; height: 150px;"></div>
        ...
        <div class="form-row flex-row">
            ...
            <div class="form-row__col-30 gap-20">
                ...
                <?php if (!empty($arResult['ITEMS']['count_door_' . $sectCode]['VALUES'])): ?>
                    <div class="form-row__col <?= ($arResult['ITEMS']['count_door_' . $sectCode]['HAS_CHECKED']) ? 'store-active' : '' ?>">
                        <div class="custom-select-inner form-group-custom-select">
                            <div class="custom-select--multiple">
                                <select id="mainGear"
...
<!--            --><?php //endif; ?>
            ...
            <div class="form-row__col-30">
                <div class="form-row form-row-checkbox selection-block-checkbox-row selection-block-checkbox-row--s">
                    ...
                    <div class="col">
                        <input type="checkbox"
                               class="input-checkbox"
                               name="<?= $arParams['FILTER_NAME'] ?>_photo"
                               id="photo"
                    ...
                    <div class="col">
                        <input type="checkbox"
                               class="input-checkbox"
                               name="<?= $arParams['FILTER_NAME'] ?>_video"
                               id="video"
                               value="Y"
                            <?= ($_GET[$arParams['FILTER_NAME'] . '_video']) ? 'checked' : '' ?>
                               data-val="С видео"
                        >
        ...
        <div class="row-border">
            <div class="form-row flex-row location-group-select">
                <div class="form-row__col-30 select-loc <?= ($_GET[$arParams['FILTER_NAME'] . '_country']) ? 'is-active' : '' ?>">
                ...
                <div class="form-row__col-30 select-loc select-region <?= ($_GET[$arParams['FILTER_NAME'] . '_region']) ? 'is-active' : '' ?>">
                    <div class="form-group custom-select-inner form-group-custom-select">
                        <div class="form-row">
                ...
                <div class="form-row__col-30 select-loc select-city <?= ($_GET[$arParams['FILTER_NAME'] . '_city']) ? 'is-active' : '' ?>">
                    <div class="form-group custom-select-inner form-group-custom-select">
                        <div class="form-row">
