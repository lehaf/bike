...
$MESS["CP_BCS_OFFER_TREE_PROPS"] = "Свойства отбора торговых предложений";
...
$MESS["IBLOCK_SECTION_ID"] = "Ограничить разделом (ID)";
$MESS["IBLOCK_SECTION_CODE"] = "Ограничить разделом (символьный код)";
...
$MESS["T_ELEMENTS_SOURCE"] = "Отображать товары";
$MESS["CP_BCS_CUSTOM_FILTER"] = "Фильтр товаров";
$MESS["CP_BCS_SETTINGS_INVALID_CONDITION"] = "Условие задано неверно";

$MESS['HIT_PROP'] = 'Свойство со значениями для табов';
$MESS['ADD_PICT_PROP_NAME'] = "Свойство с дополнительными картинками";
$MESS['FROM_THEME'] = "Из настроек решения";

$MESS['T_SHOW_TABS'] = 'Группировать товары по табам';
$MESS['T_TABS_FILTER'] = 'Тип табов';
$MESS['T_TABS_FILTER_PROPERTY'] = 'По значениям свойства типа "список"';
$MESS['T_TABS_FILTER_SECTION'] = 'По дочерним разделам';

$MESS['AJAX_LOAD'] = 'Отложенная загрузка блока для главной страницы сайта';
