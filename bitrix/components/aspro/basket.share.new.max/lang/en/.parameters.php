...
$MESS['BSN_P_SHOW_QRCODE_TITLE'] = 'Display qr code';
...
$MESS['BSN_P_MESS_URL_COPY_HINT_TITLE'] = 'Copy link button text';
$MESS['MESS_URL_COPY_HINT_TIP'] = 'Copy link';
$MESS['BSN_P_MESS_URL_COPY_HINT_DEFAULT'] = 'Copy link';
$MESS['BSN_P_MESS_URL_COPIED_HINT_TITLE'] = 'Notification that the link has been copied';
$MESS['MESS_URL_COPIED_HINT_TIP'] = 'Link copied';
$MESS['BSN_P_MESS_URL_COPIED_HINT_DEFAULT'] = 'Link copied';
...
$MESS['BSN_P_MESS_QR_CODE_HINT_TITLE'] = 'Description under qr code';
$MESS['MESS_QR_CODE_HINT_TIP'] = 'Scan qr code to open from phone';
$MESS['BSN_P_MESS_QR_CODE_HINT_DEFAULT'] = 'Scan qr code to open from phone';