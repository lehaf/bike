	...
	<div class="catalog-delivery-title">
		...
		<?if($arResult['LOCATION'] && !$arResult['ERROR'] && $arParams['SHOW_LOCATION_SOURCE'] === 'Y'):?>
			<div class="catalog-delivery-locationsource">
				...
				<?elseif($arResult['LOCATION_SOURCE'] === 'regionality'):?>
					<div class="alert alert-warning compact"><?=Loc::getMessage('CD_T_LOCATION_SOURCE_REGIONALITY')?></div>
				<?elseif($arResult['LOCATION_SOURCE'] === 'session'):?>
					<div class="alert alert-warning compact"><?=Loc::getMessage('CD_T_LOCATION_SOURCE_SESSION')?></div>
				<?elseif($arResult['LOCATION_SOURCE'] === 'property'):?>
					<div class="alert alert-warning compact"><?=Loc::getMessage('CD_T_LOCATION_SOURCE_PROPERTY')?></div>
				<?elseif($arResult['LOCATION_SOURCE'] === 'params'):?>
					<div class="alert alert-warning compact"><?=Loc::getMessage('CD_T_LOCATION_SOURCE_PARAMS')?></div>
				<?elseif($arResult['LOCATION_SOURCE'] === 'request'):?>
					<div class="alert alert-warning compact"><?=Loc::getMessage('CD_T_LOCATION_SOURCE_REQUEST')?></div>
				<?endif;?>
			</div>
		<?endif;?>
	</div>
							...
							<div class="catalog-delivery-field catalog-delivery-field_locationsearch">
								<?$APPLICATION->IncludeComponent(
									...
									Array(
										...
										"SUPPRESS_ERRORS" => "N",
										"JS_CONTROL_DEFERRED_INIT" => 'catalog-delivery__sale-locations-'.$arResult['RAND'],
									),
									false,
									array('HIDE_ICONS' => 'Y')
								);?>
							...
							<div class="catalog-delivery-field catalog-delivery-field_persontype">
								...
								<div class="catalog-delivery-field-input">
									<div class="catalog-delivery-field-box hasdropdown">
										...
										<div class="catalog-delivery-field-box-dropdown scrollblock">
											<?if($arResult['PERSON_TYPE']):?>
												<?foreach($arResult['PERSON_TYPE'] as $arPersonType):?>
	...
	BX.ready(function(){
		let t = setInterval(function(){
			if (
				...
				window.BX.locationsDeferred['catalog-delivery__sale-locations-<?=$arResult['RAND']?>']();
